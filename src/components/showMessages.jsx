...
const ShowMessages = () => {
  ...
  return (
    <div className='absolute top-0 text-center bg-black w-full h-full'>
      ...
      <div className={`relative h-[33rem] ${theme} shadow-2xl border-2 border-orange-100 rounded-3xl w-1/2 mx-auto mt-5 no-scrollbar px-3 py-10 space-y-2 overflow-y-scroll`}>
